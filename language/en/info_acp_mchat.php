...
$lang = array_merge($lang, array(
	...
	'ACP_MCHAT_RULES_EXPLAIN'				=> 'Enter the rules of the forum here. Each rule on a new line. You are limited to 255 characters. This message can be translated: edit the MCHAT_RULES_MESSAGE language key in /ext/dmzx/mchat/language/XX/common.php.',
	...
	'MCHAT_PRUNE_EXPLAIN'					=> '<em>Only occurs if a user views the custom or archive pages</em>.',
	'MCHAT_PRUNE_NUM'						=> 'Number of messages to retain',
	...
	'MCHAT_WHOIS'							=> 'Whois',
	'MCHAT_WHOIS_EXPLAIN'					=> 'Display users who are chatting',
	'MCHAT_WHOIS_REFRESH'					=> 'Whois refresh',
	'MCHAT_WHOIS_REFRESH_EXPLAIN'			=> 'Number of seconds before whois chatting refreshes.<br /><em>You are limited from 30 to 300 seconds</em>.',
	...
	'MCHAT_STATIC_MESSAGE_EXPLAIN'			=> 'Here you can define a static message to display to users of the chat. HTML code is allowed.<br />Set to empty to disable the display. You are limited to 255 characters.<br />This message can be translated: edit the MCHAT_STATIC_MESSAGE language key in /ext/dmzx/mchat/language/XX/common.php.',
	...
	'MCHAT_STATS_INDEX_EXPLAIN'				=> 'Show who is chatting within the stats section of the forum',
